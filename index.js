...
function artistByCountry(arr, nationalityInput){
  let nationalArtists = [];
  for(let i = 0; i < arr.length; i++){
    if(arr[i].nationality === nationalityInput){
      nationalArtists.push(arr[i].name);
    }
  }
